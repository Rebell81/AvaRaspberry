...
namespace SynologyClient
{
    ...
    {
        public static ISynologyClientConfig Conf;
    }
    ...
    public class SynologyApi : ISynologyApi
    {
        ...
        public SynologyApi(ISynologySession session, ISynologyClientConfig conf)
        {
            if (session == null)
        ...
        {
            var proc = new FuncProcessor<GetDiskstationUtilizationResponse>("/entry.cgi", _session.sid, new
            {
